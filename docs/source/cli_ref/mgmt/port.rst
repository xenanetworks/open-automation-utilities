...
.. code-block:: text
    ...
    xoa_util[123456][port0/0] > port 0/1
    Ports       Sync
    0/0         yes
    *0/1        yes
    ...
    xoa_util[123456][port0/1] > port 0/0
    Ports       Sync
    *0/0        yes
    0/1         yes
    ...
    xoa_util[123456][port0/0] > port 0/2 --no-reset
    Ports       Sync
    0/0         yes
    0/1         yes
    *0/2        yes
...
.. code-block:: text
    ...
    *0/1        yes
    ...
    xoa_util[123456][port0/1] >


.. code-block:: text

    xoa_util[123456][port0/1] > port 0/2 --no-force
    Ports       Sync
    0/0         yes
    *0/1        yes
